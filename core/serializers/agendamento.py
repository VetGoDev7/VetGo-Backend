...
class AgendamentoSerializer(serializers.ModelSerializer):
    ...
    pet = serializers.PrimaryKeyRelatedField(queryset=Pet.objects.none(), write_only=True)
    ...
    def validate(self, attrs):
        ...
        # Garantir que o tutor só agende para seus próprios pets
        ...
        # Conflito de horário para pet (apenas agendamentos futuros)
